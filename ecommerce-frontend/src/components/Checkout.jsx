      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            {error && (
              <div className="bg-red-50 border-2 border-red-200 text-red-800 p-4 rounded-xl mb-6">
                {error}
              </div>
            )}
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-700 hover:to-orange-800 text-white font-bold py-5 px-6 rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-0.5 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed text-lg">
              {loading ? (
                <>
                  <svg
